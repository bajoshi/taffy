...
if __name__ == '__main__':
    ...
    taffy_b.writeto(taffy_datadir + 'Taffy_B_smoothed_nonoisechange.fits', output_verify='ignore', clobber=True)
    taffy_r.writeto(taffy_datadir + 'Taffy_R_smoothed_nonoisechange.fits', output_verify='ignore', clobber=True)
